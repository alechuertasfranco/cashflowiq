// lib/features/transactions/presentation/transfer_transaction/widgets/transfer_step_from.dart
...
class TransferStepFrom extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text("¿Desde dónde?", style: AppTextStyles.h400(context)),
