// lib/features/transactions/presentation/recurring/widgets/recurring_step_category.dart
...
class RecurringStepCategory extends StatelessWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(child: Text("¿En qué categoría?", style: AppTextStyles.h400(context))),
          ...
          if (categories.isEmpty)
            _EmptyHint(
              message: "Aún no tienes categorías.",
