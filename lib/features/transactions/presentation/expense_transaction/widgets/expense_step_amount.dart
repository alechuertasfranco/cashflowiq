// lib/features/transactions/presentation/expense_transaction/widgets/expense_step_amount.dart
...
class ExpenseStepAmount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text("¿Cuánto gastaste?", style: AppTextStyles.h400(context)),
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  Text("Cambiar", style: AppTextStyles.body2(context, color: AppColors.error)),
                ],
              ),
            ),
          ),
