// lib/features/transactions/presentation/income_transaction/widgets/income_step_account.dart
...
class IncomeStepAccount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text("¿A qué cuenta?", style: AppTextStyles.h400(context)),
