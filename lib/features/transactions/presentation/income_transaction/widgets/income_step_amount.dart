// lib/features/transactions/presentation/income_transaction/widgets/income_step_amount.dart
...
class IncomeStepAmount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text("¿Cuánto recibiste?", style: AppTextStyles.h400(context)),
